...
const HomeDescription = () => {
  const [hasLoadded, setHasLoaded] = useState(false);
  const description = `AAs a Software Engineer, I design and build innovative software
        solutions, solve complex problems, and ensure systems are scalable and
        user-friendly. From creating web pps to optimizing backend systems, I
  ...
  return (
    <motion.p
      className="w-auto font-normal leading-7 mb-6 min-h-36"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
